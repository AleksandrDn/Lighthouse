		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2  style=" font-family: 'Chewy', cursive !important;font-weight: normal !important;font-size: 24px;">
					<img src="/img/glyphicons/glyphicons-387-log-in.png"/> Вход в систему
				</h2>
	...
	<div id="login-form" style="width: 400px">
        ...
        <fieldset>
            <form method="post" action="<c:url value='j_spring_security_check' />">
                <input type="email" name="username" required value="E-mail" onBlur="if(this.value=='')this.value='E-mail'" onFocus="if(this.value=='E-mail')this.value='' ">
                ...
                <footer class="clearfix">
                    <p><span class="info">?</span><a class="loginHint" href="/registrationform">Не зарегестрированы?</a></p>
                </footer>
            </form>
        </fieldset>
		<div id="login-fail-message" style="display: none" class="alert alert-error">${message}</div>
    </div>
