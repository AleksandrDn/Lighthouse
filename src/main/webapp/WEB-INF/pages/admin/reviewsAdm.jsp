  ...
  <nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
      <ul class="nav" id="main-menu">
        ...
        <li>
          <a class="active-menu" href="/admin/reviewsAdm"><i class="fa fa-thumbs-o-up"></i> Отзывы</a>
        </li>
      </ul>
      ...
      <div class="row">
        <div class="col-md-12">
          <h1 class="page-header">
            Отзывы <small>Управление отзывами</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="panel-body">
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody id="all_reviews_placeholder">
...
<script src="/dashboard/js/dataTables/reviews_loader.js"></script>
<script>
