  ...
  <nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
      <ul class="nav" id="main-menu">
        ...
        <li>
          <a href="/admin/newsAdm"><i class="fa fa-desktop"></i> Новости</a>
        </li>
        <li>
          <a href="/admin/clientAdm"><i class="fa fa-users"></i> Клиенты</a>
        </li>
        <li>
          <a class="active-menu" href="/admin/phonesAdm"><i class="fa fa-phone"></i> Телефоны</a>
        </li>
        <li>
    ...
    <div id="page-inner">
      ...
      <div class="row">
        <div class="col-md-12">
          <h1 class="page-header">
            Телефоны <small>Измененение номеров телефонов</small>
          </h1>
          <ol class="breadcrumb">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-6">
              <form role="form" action="/admin/administrationPhoneAdm" method="post">
                <div class="form-group">
                  <label>Администрация</label>
                  <input name="administrator" class="form-control" placeholder="${administrator}">
                </div>
                <button type="submit" class="btn btn-default">Изменить</button>
              </form>
              <form role="form" action="/admin/receptionPhoneAdm" method="post">
                <div class="form-group">
                  <label>Ресепшн</label>
                  <input name="reception" class="form-control" placeholder="${reception}">
                </div>
                <button type="submit" class="btn btn-default">Изменить</button>
              </form>
            </div>
...
<script src="/dashboard/js/dataTables/clients_loader.js"></script>
<script>
